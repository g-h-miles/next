                  ...
                  <>
                    {item?.dropdownItems ? (
                          ...
                          >
                            <span className="flex items-center">
                              {item?.icon && (
                                <span
                                  className={cn(
                                    'me-2 inline-flex h-5 w-5 items-center justify-center rounded-full [&>svg]:h-[19px] [&>svg]:w-[19px]',
                                    isDropdownOpen
                                      ? 'text-primary'
                        ...
                        {item?.dropdownItems?.map((dropdownItem, index) => {
                          ...
                          return (
                            <Link
                              ...
                              className={cn(
                                'mx-3.5 mb-0.5 flex items-center rounded-full px-3.5 py-2 font-medium capitalize last-of-type:mb-1 lg:last-of-type:mb-2 2xl:mx-5',
                                isChildActive
                                  ? 'text-gray-900'
                      ...
                      <Link
                        href={item?.href}
                        className={cn(
                          'group relative mx-3 my-0.5 flex items-center rounded-full px-3 py-2 font-medium capitalize lg:my-1 2xl:mx-5 2xl:my-2',
                          isActive
